...
### Added
- `Logger.log()` method, an alias for `Logger.debug()`.
...
[Unreleased]: https://github.com/pyrologic/pyrologjs/compare/v2.2.1...HEAD
[2.2.1]: https://github.com/pyrologic/pyrologjs/compare/v2.2.0...v2.2.1
